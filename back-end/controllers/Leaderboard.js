    ...
    try {
        ...
        if (tid) {
            ...
            const [specificUserResults] = await sequelize.query(`
                SELECT e.tap_score, t.username, e.game_level, e.id, t.first_name from tg_users as t JOIN earnings as e ON t.userid = e.userid where t.userid='${tid}' order by e.tap_score desc;
